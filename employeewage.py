...
class Employee:
    ...
    def calc_wage(self):
        """
        Function calculate wage of month
    ...
    try:
        ...
        while True:
            ...
            if choice == 1:
                ...
                maximum_working_hrs = int(
                    input("Enter employee work hours : "))
                maximum_working_days = int(
                    input("Enter employee working days : "))
                employee = Employee(
                    employee_name, employee_wage, maximum_working_hrs, maximum_working_days)
